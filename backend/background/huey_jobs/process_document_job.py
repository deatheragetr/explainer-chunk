...
async def async_process_document(
    input_text: str, document_id: str, model_pair_config: ModelPairConfig
):
...
def process_document(
    input_text: str, document_id: str, model_name: str = "gpt-4o-mini"
):
    ...
    try:
        ...
        try:
            loop.run_until_complete(
                async_process_document(input_text, document_id, model_pair_config)
            )
        finally:
